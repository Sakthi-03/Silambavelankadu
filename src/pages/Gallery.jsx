...
const Gallery = () => {
  ...
  const images = [
    {
      url: '/Silambavelankadu/images/Temples/Murugan Temple.png',
    ...
    {
      url: '/Silambavelankadu/images/Temples/Kaliamman.PNG',
    ...
    {
      url: '/Silambavelankadu/images/Nature/nature1.png',
      title: 'இயற்கை காட்சி',
    ...
    {
      url: '/Silambavelankadu/images/Agri/paddy.png',
      title: 'நாற்று நடவு',
    ...
    {
      url: '/Silambavelankadu/images/Agri/coconut.jpg',
      title: 'தென்னந்தோப்பு',
    ...
    {
      url: '/Silambavelankadu/images/Temples/temple.png',
    ...
    {
      url: '/Silambavelankadu/images/Nature/pond1.png',
    ...
    {
      url: '/Silambavelankadu/images/Nature/Kasankuttai.jpg',
    ...
    {
      url: '/Silambavelankadu/images/Temples/pond.jpg',
      title: 'ஊரணி',
    ...
    {
      url: '/Silambavelankadu/images/Agri/paddy1.jpg',
    ...
    {
      url: '/Silambavelankadu/images/Agri/groundnut.png',
